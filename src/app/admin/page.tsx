...
const TopYouthBars = nextDynamic(() => import("@/components/charts/TopYouthBars"), { ssr: false });
const GroupCompareBars = nextDynamic(() => import("@/components/charts/GroupCompareBars"), { ssr: false });
