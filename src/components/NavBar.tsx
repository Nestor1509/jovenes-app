...
export default function NavBar() {
  // ✅ usar el estado global del AuthProvider (más rápido y consistente)
  ...
  // ✅ Esto es lo que acelera la percepción:
  // - Si hay sesión, mostramos algo aunque profile aún no llegue.
  // - El error solo lo mostramos si NO hay sesión (si hay sesión, no es “login fallido”).
  const userLine = useMemo(() => {
    if (!hasSession) {
