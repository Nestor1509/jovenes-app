    ...
    <div style={{ width: "100%", height }}>
      <ResponsiveContainer width="100%" height="100%" minHeight={height}>
        <LineChart data={data} margin={{ top: 10, right: 18, left: 0, bottom: 18 }}>
          <defs>
            <linearGradient id="tl_lectura" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0%" stopColor="rgba(245,158,11,0.85)" />
              <stop offset="100%" stopColor="rgba(245,158,11,0.35)" />
            </linearGradient>
            <linearGradient id="tl_oracion" x1="0" y1="0" x2="1" y2="0">
          ...
          <Tooltip
            ...
            formatter={(value: any, name) => {
              if (name === "lectura") return [fmtChapters(Number(value)), "Capítulos"];
